...
SQL Injection (SQLi) is an **server-side attack** that occurs when an application includes user input directly in an SQL query without handling it safely. It mainly affects **database-driven applications**, including web applications and APIs.
